...
class lstm(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size, time_step, num_layers):
        ...
        self.Linear1 = nn.Linear(2 * time_step * hidden_size, 2 * time_step * hidden_size)
        self.Linear2 = nn.Linear(2 * time_step * hidden_size, 2 * time_step * hidden_size)
        self.Linear_N21 = nn.Linear(2 * time_step * hidden_size, output_size)
...
rnn = lstm(INPUT_SIZE, HIDDEN_CELLS, OUTPUT_SIZE, TIME_STEP, LAYER_NUM)
